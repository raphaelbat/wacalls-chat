...
export type Whitelabel = {
  ...
  primaryLight?: string;
  primaryDark?: string;
  // Cor dos ícones do menu lateral. Opcional — quando vazio, os ícones
  // seguem a cor primária acima. Existe como campo separado porque uma
  // cor primária muito clara (ex.: branco) deixaria os ícones invisíveis.
