...
export interface FlowNodeData {
  ...
  // `weight` é o peso relativo no sorteio do chat_random.
  options?: Array<{ key: string; label: string; synonyms?: string[]; next?: string; type?: string; queueId?: string; queueName?: string; weight?: number }>;
